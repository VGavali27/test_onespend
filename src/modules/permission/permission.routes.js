...
router.get('/:uuid', permissionController.getPermissionByUuid);
...
router.put('/:uuid', validate(updatePermissionSchema), permissionController.updatePermission);

// Soft delete a permission by UUID
router.delete('/:uuid', permissionController.deletePermission);
