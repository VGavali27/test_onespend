...
// Schema for creating a company — group_uuid is required, most other fields are optional
export const createCompanySchema = Joi.object({
  group_uuid: Joi.string().uuid().required().messages({
    'string.guid': 'Group UUID must be a valid UUID',
...
export const updateCompanySchema = Joi.object({
  group_uuid: Joi.string().uuid().messages({
    'string.guid': 'Group UUID must be a valid UUID',
  }),
