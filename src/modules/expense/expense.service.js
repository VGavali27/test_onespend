...
class ExpenseService {
  ...
  // Create an expense — handles nested module data based on category
  async create(data) {
    ...
    // Extract module-specific fields (travel, etc.)
    const travelFields = {};
    ...
    // Clean data for expense creation
    const {
      category_uuid,
      company_uuid,
    ...
    return sequelize.transaction(async (t) => {
      ...
      // 2. If travel module, create travel expense and child items
