...
router.get('/by-expense/:expenseUuid', reimbursementController.getReimbursementByExpense);
// Update a reimbursement (header + items) by its own UUID
router.put('/:uuid', validate(updateReimbursementSchema), reimbursementController.updateReimbursement);
