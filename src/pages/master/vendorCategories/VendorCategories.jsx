...
export default function VendorCategories() {
  ...
  const canCreate = hasPermission('vendor_categories:create');
  const canUpdate = hasPermission('vendor_categories:update');
  const canDelete = hasPermission('vendor_categories:delete');
