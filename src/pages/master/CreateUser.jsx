...
export default function CreateUser() {
  ...
  // Load dropdowns for the form on mount
  useEffect(() => {
    const load = async () => {
      try {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      >
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-slate-200 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-800/40 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={goBack}
            className="px-4 py-2.5 rounded-lg text-[13px] font-semibold text-slate-600 dark:text-slate-300 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 hover:bg-slate-50 dark:hover:bg-gray-700 transition-colors"
          >
            Cancel
          </button>
          <button
