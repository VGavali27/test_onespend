...
export async function up({ context }) {
  return context.bulkInsert('expense_categories', [
    ...
    {
      id: 101,
      uuid: 'a2b3c4d5-e6f7-8901-abcd-ef1234567802',
      code: 'REIMBURSEMENT',
      module: 'reimbursement',
      name: 'Reimbursement',
      description: 'Employee expense reimbursements (non-travel)',
      first_receiver_role_id: 104,   // FINANCE_MGR
      final_approver_role_id: 101,   // CFO
      status: 'ACTIVE',
      created_at: new Date(),
...
export async function down({ context }) {
  return context.bulkDelete('expense_categories', { id: [100, 101] }, {});
}
