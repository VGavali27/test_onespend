export async function up(queryInterface, Sequelize) {
  await queryInterface.createTable('travel_expense_forex', {
    ...
    exchange_rate: { type: Sequelize.DECIMAL(15, 6), allowNull: false },
    estimated_foreign_amount: { type: Sequelize.DECIMAL(15, 2), allowNull: false, defaultValue: 0.0 },
    final_foreign_amount: { type: Sequelize.DECIMAL(15, 2), allowNull: false, defaultValue: 0.0 },
  ...
  await queryInterface.addIndex('travel_expense_forex', ['travel_expense_id'], { name: 'idx_tef_travel' });
  await queryInterface.addConstraint('travel_expense_forex', {
    fields: ['travel_expense_id'],
    type: 'foreign key',
    name: 'fk_tef_travel_expense_id',
...
export async function down(queryInterface, _Sequelize) {
  await queryInterface.dropTable('travel_expense_forex');
}
