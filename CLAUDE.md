...
### Today's Updates (2026-09-08) — Procurement Expense 7-Step Approval + Admin Fulfilment
The procurement expense now runs a **fixed 7-step approval ladder** (no handover dropdown) and, once approved, is fulfilled by ADMIN_MGR: signed PO PDF + received quantities + vendor invoice. PO line items track delivered quantities, and a backstop blocks payment until every item is fully received.
